...
export const CATEGORIES = [
    ...
    { title: 'Ammo', icon: 'ammo', screen: 'details' },
    // export { default as handguns } from './handguns.svg'
    { title: 'handguns', icon: 'handguns', screen: 'details' },
    // export { default as rifles } from './rifles.svg'
    { title: 'rifles', icon: 'rifles', screen: 'details' },
    // export { default as shotguns } from './shotguns.svg'
    { title: 'shotguns', icon: 'shotguns', screen: 'details' },
    // export { default as gun_parts } from './gun-parts.svg'
    { title: 'gun parts', icon: 'gun_parts', screen: 'details' },
    // export { default as knives } from './knives.svg'
    { title: 'knives', icon: 'knives', screen: 'details' },
    // export { default as accessories } from './accessories.svg'
    { title: 'accessories', icon: 'accessories', screen: 'details' },
